...
#  Created on Tue Mar  6 19:20:14 2018                
#                                                     
#######################################################
...
saveNetlist -excludeLeafCell final.v
rcOut -spf final.dspf
verifyConnectivity -type all -noAntenna -noWeakConnect -noUnroutedNet -connLoop -noSoftPGConnect -error 1000 -warning 50
verifyConnectivity -type all -noAntenna -noWeakConnect -noUnroutedNet -connLoop -noSoftPGConnect -error 1000 -warning 50
verifyConnectivity -type all -geomLoop -noSoftPGConnect -error 1000 -warning 50
zoomBox -479.530 158.329 -652.009 180.687
fit
